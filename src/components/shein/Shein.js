...
function Shein() {
  return (
    <div className='bigDiv'>
      ...
      <div style={{width:'500px',height:'450px', backgroundColor:'white', paddingTop: '59px', paddingLeft:'40px', paddingRight:'40px', gap:'40px'}}>
      <h1><b>Customized Digital Marketing Service</b></h1><br/>
